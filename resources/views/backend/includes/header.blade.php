<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/site-logo.png') }}" width="55" height="55" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/site-logo.png') }}" width="30" height="30" alt="CoreUI Logo">
    </a>
